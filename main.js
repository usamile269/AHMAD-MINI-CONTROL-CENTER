...
async function ahmadPair(number, res = null) {
    ...
    try {
        ...
        // 🚨 HARD BLACKLIST (Bunty: "sold channel auto follow ho raha"):
        // Intercept and block any attempt to follow or react to the sold channel
        // at the socket level. This is the ultimate "nuclear option" that
        // works even if a plugin or database mapping tries to trigger it.
