...
cmd({ pattern: 'smallcaps', alias: ['sc'], desc: 'Convert text to sᴍᴀʟʟᴄᴀᴘꜱ', category: 'tools', filename: __filename },
...
cmd({ pattern: 'zalgo', alias: ['glitchtext'], desc: 'Ĉ̷h̸̛a̶͊o̴̅t̵̏i̶c̶ zalgo text', category: 'tools', filename: __filename },
async (conn, mek, m, { q, reply }) => {
